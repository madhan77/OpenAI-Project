...
- **Firebase Hosting:** `https://open-ai-project-723a7.web.app/` or `https://open-ai-project-723a7.firebaseapp.com/` once you deploy the `/portal` folder to the provided Firebase project.
